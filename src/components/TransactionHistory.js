...
const TransactionHistory = () => {
  ...
  useEffect(() => {
    ...
    if (amountFilter) {
      filtered = filtered.filter((transaction) => transaction.amount === Number(amountFilter));
    }
    ...
    if (filterDate) {
      filtered = filtered.filter((transaction) => new Date(transaction.date).toLocaleDateString() === filterDate);
    }
          ...
          {filteredTransactions.map((transaction) => (
            <div className="transaction-card" key={transaction._id}>
              ...
              <div className="card-body">
                ...
                <p><strong>Amount:</strong> {transaction.type.toLowerCase() === 'withdrawal'
                  ? transaction.amount
                  : transaction.ngnAmount} NGN</p>
              </div>
      ...
      {receipt && (
        <div className="receipt-modal">
          ...
          <div className="receipt-footer">
            <p>Thank you for using Exdollarium!</p>
            <p>Contact Support: support@exdollarium.com</p>
          </div>
